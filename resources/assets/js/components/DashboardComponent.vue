<template>
    <div>
        ...
        <div class="toolbar-buttons pull-right">
            <a class="btn btn-primary" v-on:click.native="addPlayerButtonClick" href="#" role="button">Add Player</a>
            <a class="btn btn-primary" v-on:click.native="addGameButtonClick" href="#" role="button">Add Game</a>
        </div>
